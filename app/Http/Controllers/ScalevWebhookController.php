            ...
            if ($orderId) {
                ...
                try {
                    ...
                    if ($cfg && $phone) {
                        ...
                        $priceFmt = $variantPrice ? number_format((float)$variantPrice, 0, ',', '.') : ($netRevenue ? number_format((float)$netRevenue, 0, ',', '.') : '...');
                        $msg = "Hai kak *".$nm."*, 👋😊\n\n".
                               "Pesanan *".$pn."* sudah berhasil kami terima.\n\n".
                               "Supaya kakak *bisa langsung pakai aplikasinya*, silakan selesaikan pembayarannya ya.🙏\n\n".
                               "Totalnya dari hanya ~897.000~ menjadi hanya *".$priceFmt."*.\n\n".
